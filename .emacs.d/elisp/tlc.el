...
;; X-RCS: $Id: tlc.el,v 1.1.1.1 2007/11/14 03:07:19 awdeorio Exp $
...
;;; Code:
(defvar tlc-version "$Revision: 1.1.1.1 $"
...
(make-face 'tlc-font-lock-output-code)
(set-face-foreground tlc-font-lock-output-code "DarkGreen")

(defvar tlc-keywords '("CAST" "EXISTS" "FEVAL" "FILE_EXISTS" "FORMAT" 
